...
이 프로젝트의 이미지는 Wikimedia Commons에서 내려받았습니다.

## 경복궁

- 파일: `images/gyeongbokgung.jpg`
- 작품: Korea Gyeongbokgung
- 촬영자: LASZLO ILYES
- 라이선스: CC BY 2.0
- 출처: https://commons.wikimedia.org/wiki/File:Korea_Gyeongbokgung.jpg

## 동대문디자인플라자

- 파일: `images/ddp.jpg`
- 작품: Dongdaemun Design Plaza at night, Seoul, Korea
- 촬영자: Eugene Lim
- 라이선스: CC BY 2.0
- 출처: https://commons.wikimedia.org/wiki/File:Dongdaemun_Design_Plaza_at_night,_Seoul,_Korea.jpg

## 별마당도서관

- 파일: `images/starfield-library.jpg`
- 작품: Starfield library 4
- 촬영자: Sgroey
- 라이선스: CC BY-SA 4.0
